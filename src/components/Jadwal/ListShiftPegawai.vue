<template>
    <v-main class="list">
        <v-card>
            ...
            <v-data-table :headers="headers" :items="detailjadwals" :search="search" :loading="load">
    ...
    export default {
       ...
       methods: {
        ...
        //    },
           ...
           readData() {
               this.overlay = true;
               var url = this.$api + '/detailjadwal/get/idpegawai/' + localStorage.getItem('id_pegawai');
               this.$http.get(url, {
                   headers: {

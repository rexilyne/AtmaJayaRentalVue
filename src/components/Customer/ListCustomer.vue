<template>
    <v-main class="list">
        <v-card>
            ...
            <v-data-table :headers="headers" :items="customers" :search="search" :loading="load">
                <template v-slot:[`item.url_sim`]="{ item }">

      <div align="center" v-if="item.url_sim === '-'">-</div>
        ...
        <template v-slot:[`item.url_kartu_identitas`]="{ item }">
          <div class="p-2">
            <v-img
              :src="item.url_kartu_identitas"
              alt="-"
              height="100px"
              width="100px"
            ></v-img>
